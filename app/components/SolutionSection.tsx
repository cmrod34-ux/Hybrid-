...
const features = [
  {
    ...
    icon: (
      <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
        <path d="M11 2L3 6v5c0 4.5 3.5 8.7 8 10 4.5-1.3 8-5.5 8-10V6l-8-4z" stroke="#3b82f6" strokeWidth="1.5" strokeLinejoin="round"/>
        <path d="M7.5 11l2.5 2.5 4.5-4.5" stroke="#3b82f6" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
      </svg>
    ),
  ...
  },
  {
    ...
    icon: (
      <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
        <circle cx="8" cy="11" r="5" stroke="#ef4444" strokeWidth="1.5"/>
        <circle cx="14" cy="11" r="5" stroke="#ef4444" strokeWidth="1.5" opacity="0.5"/>
        <path d="M11 8v6M9 10l2-2 2 2" stroke="#ef4444" strokeWidth="1.3" strokeLinecap="round"/>
      </svg>
    ),
  ...
  },
  {
    ...
    icon: (
      <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
        <path d="M11 3l2.5 5 5.5.8-4 3.9.95 5.5L11 16l-4.95 2.2.95-5.5L3 8.8 8.5 8z" stroke="#3b82f6" strokeWidth="1.5" strokeLinejoin="round"/>
      </svg>
    ),
  ...
  },
  {
    ...
    icon: (
      <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
        <path d="M4 10h14M4 14h9" stroke="#ef4444" strokeWidth="1.5" strokeLinecap="round"/>
        <rect x="3" y="6" width="16" height="12" rx="2" stroke="#ef4444" strokeWidth="1.5"/>
        <path d="M7 6V4M15 6V4" stroke="#ef4444" strokeWidth="1.5" strokeLinecap="round"/>
      </svg>
    ),
    title: "Nutrition AI",
  ...
  },
  {
    ...
    icon: (
      <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
        <path d="M11 4C7.13 4 4 7.13 4 11s3.13 7 7 7 7-3.13 7-7-3.13-7-7-7z" stroke="#3b82f6" strokeWidth="1.5"/>
        <path d="M11 8v3l2 2" stroke="#3b82f6" strokeWidth="1.5" strokeLinecap="round"/>
        <path d="M17.5 4.5l-1.5 1.5M4.5 17.5l1.5-1.5" stroke="#3b82f6" strokeWidth="1.3" strokeLinecap="round" opacity="0.5"/>
      </svg>
    ),
  ...
  },
  {
    ...
    icon: (
      <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
        <path d="M4 16l4-4 3 3 4-5 3 3" stroke="#ef4444" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
        <rect x="3" y="3" width="16" height="16" rx="2" stroke="#ef4444" strokeWidth="1.5" opacity="0.4"/>
      </svg>
    ),
  ...
  return (
    <section className="py-24 px-6 relative">
      ...
      <div className="max-w-6xl mx-auto relative">
        ...
        {/* Section label */}
        <p className="text-blue-400 text-xs font-semibold uppercase tracking-widest mb-4 text-center">The Solution</p>
